...
class CategoryTheme {
  ...
  static const Map<String, CategoryStyle> styles = {
    ...
    'Food': CategoryStyle(
      ...
      emoji: '🍔',
      label: 'Ăn uống',
      iconAsset: '$_base/Food.png',
    ),
    'Transport': CategoryStyle(
      color: Color(0xFF3B82F6),
      emoji: '🚗',
      label: 'Di chuyển',
      iconAsset: '$_base/Transport.png',
    ),
    'Shopping': CategoryStyle(
      color: Color(0xFF8B5CF6),
      emoji: '🛍️',
      label: 'Mua sắm',
      iconAsset: '$_base/Shopping.png',
    ),
    'Entertainment': CategoryStyle(
      color: Color(0xFFF59E0B),
      emoji: '🎬',
      label: 'Giải trí',
      iconAsset: '$_base/Entertainment.png',
    ),
    'Health': CategoryStyle(
      color: Color(0xFF10B981),
      emoji: '💊',
      label: 'Sức khỏe',
      iconAsset: '$_base/Health.png',
    ),
    'Education': CategoryStyle(
      color: Color(0xFF06B6D4),
      emoji: '📚',
      label: 'Giáo dục',
      iconAsset: '$_base/Education.png',
    ),
    'Beauty': CategoryStyle(
      color: Color(0xFFDB2777),
      emoji: '💅',
      label: 'Làm đẹp',
      iconAsset: '$_base/Beauty.png',
    ),
    'Housing': CategoryStyle(
      color: Color(0xFF22C55E),
      emoji: '🏠',
      label: 'Nhà ở',
      iconAsset: '$_base/Housing.png',
    ),
    'Social': CategoryStyle(
      color: Color(0xFFE11D48),
      emoji: '🍻',
      label: 'Xã hội',
      iconAsset: '$_base/Social.png',
    ),
    'Business': CategoryStyle(
      color: Color(0xFF0284C7),
      emoji: '💼',
      label: 'Kinh doanh',
      iconAsset: '$_base/Business.png',
    ),
    'Bonus': CategoryStyle(
      color: Color(0xFFD97706),
      emoji: '🎁',
      label: 'Thưởng',
      iconAsset: '$_base/Bonus.png',
    ),
    'Charity': CategoryStyle(
      color: Color(0xFFDC143C),
      emoji: '❤️',
      label: 'Từ thiện',
      iconAsset: '$_base/Charity.png',
    ),
    'Essentials': CategoryStyle(
      color: Color(0xFF64748B),
      emoji: '🧴',
      label: 'Đồ dùng thiết yếu',
      iconAsset: '$_base/Essentials.png',
    ),
    'Debt': CategoryStyle(
      color: Color(0xFFDC2626),
      emoji: '💸',
      label: 'Nợ',
      iconAsset: '$_base/Debt.png',
    ),
    'Investment': CategoryStyle(
      color: Color(0xFF6366F1),
      emoji: '📈',
      label: 'Đầu tư',
      iconAsset: '$_base/Investment.png',
    ),
    'Saving': CategoryStyle(
      color: Color(0xFF7C3AED),
      emoji: '🐷',
      label: 'Tiết kiệm',
      iconAsset: '$_base/Savings.png',
    ),
    'Other': CategoryStyle(
      color: Color(0xFF94A3B8),
      emoji: '📌',
      label: 'Khác',
      iconAsset: '$_base/Other.png',
    ),
    'Salary': CategoryStyle(
      color: Color(0xFF16A34A),
      emoji: '💵',
      label: 'Lương',
      iconAsset: '$_base/Salary.png',
    ),
  ...
  static Widget iconOf(String category, {double size = 24}) {
    ...
    return Image.asset(
      ...
      fit: BoxFit.contain,
      errorBuilder: (ctx, err, st) =>
          Text(style.emoji, style: TextStyle(fontSize: size * 0.75)),
    );
  }
