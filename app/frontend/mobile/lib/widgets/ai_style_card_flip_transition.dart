          ...
          children: [
            ...
            if (_showToast)
              Positioned(
                ...
                child: _SuccessToast(
                  label: 'Đã chuyển sang phong cách $_toLabel',
                ),
              ),
          ],
        ),
          ...
          Positioned.fill(
            child: GestureDetector(
              ...
              child: BackdropFilter(
                ...
                child: Container(
                  color: Colors.black.withValues(alpha: 0.08 * (blur / 12)),
                ),
              ),
            ),
          ),
                ...
                Flexible(
                  child: FittedBox(
                    ...
                    child: Image.asset(
                      ...
                      errorBuilder: (_, e, s) =>
                          Text(emoji, style: TextStyle(fontSize: width * 0.2)),
                    ),
                  ),
                ),
          ...
          if (lightSweep > 0.05)
            Positioned.fill(
              child: ClipRRect(
                ...
                child: CustomPaint(
                  painter: _CardLightSweepPainter(intensity: lightSweep),
                ),
              ),
            ),
        ],
...
class _CardLightSweepPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(covariant _CardLightSweepPainter old) =>
