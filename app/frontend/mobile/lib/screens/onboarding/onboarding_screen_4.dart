  ...
  Future<void> _finish() async {
    ...
    try {
      ...
      if (personalWallet != null) {
        ...
        await _api.updateWallet(walletId, {'name': config['name'] as String});
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 8),
                            Text(
                              'Để Mimo có thể tư vấn phù hợp với bạn nhất',
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      'Thông tin này giúp AI nhận xét chính xác hơn về chi tiêu của bạn',
