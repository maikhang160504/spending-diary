                      ...
                      : RefreshIndicator(
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final paidAmount = num.parse(
                                loan['paid_amount'].toString(),
                              );
                              final remaining = amount - paidAmount;

                              final contactName =
                                  loan['contact_name']?.toString() ?? 'Ai đó';
                              final dt = loan['due_date'] != null
                                  ? DateTime.tryParse(
                                      loan['due_date'].toString(),
                                    )?.toLocal()
                                  : null;
                              final dueDateStr = dt != null
