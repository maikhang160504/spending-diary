...
class _RecurringRulesScreenState extends State<RecurringRulesScreen> {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            backgroundColor: !currentValue ? AppColors.teal : AppColors.muted,
  ...
  String _formatDate(String dateStr) {
    try {
      ...
      final datePart = '${parsed.day.toString().padLeft(2, '0')}/${parsed.month.toString().padLeft(2, '0')}/${parsed.year}';
      final timePart = ' ${parsed.hour.toString().padLeft(2, '0')}:${parsed.minute.toString().padLeft(2, '0')}';
  ...
  Widget build(BuildContext context) {
    final activeCount = _rules.where((r) => (r['isActive'] as bool? ?? true)).length;
    ...
    return Scaffold(
          ...
          : _rules.isEmpty
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.sync_alt_rounded, color: AppColors.teal, size: 44),
                        ),
                        ...
                        FilledButton.icon(
                          ...
                          label: const Text('Thêm quy tắc đầu tiên', style: TextStyle(fontWeight: FontWeight.w700)),
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (ctx, index) {
                        ...
                        child: Row(
                          children: [
                            Container(
                              ...
                              child: const Icon(Icons.auto_mode_rounded, color: AppColors.teal, size: 26),
                            ),
                    ...
                    final walletName = rule['walletName'] as String? ?? 'Ví cá nhân';
                              ...
                              Row(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Center(child: CategoryTheme.iconOf(catCode, size: 26)),
                                  ),
                                  const SizedBox(width: 14),
                                  Expanded(
                                    child: Column(
                                ...
                                child: Row(
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: _frequencyColor(freq).withValues(alpha: 0.14),
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                      fontSize: 13,
                                      fontWeight: FontWeight.w600,
                                      color: isActive ? AppColors.teal : context.palette.textSecondary,
                                    ),
                                  ),
                                  const Spacer(),
                                  TextButton.icon(
                                    onPressed: () => _openAddRuleSheet(rule: rule),
                                    icon: const Icon(Icons.edit_outlined, size: 17, color: AppColors.teal),
                                    label: const Text('Sửa', style: TextStyle(color: AppColors.teal, fontWeight: FontWeight.w600, fontSize: 13)),
                                  ...
                                  TextButton.icon(
                                    ...
                                    label: const Text('Xóa', style: TextStyle(color: AppColors.danger, fontWeight: FontWeight.w600, fontSize: 13)),
                                    style: TextButton.styleFrom(
                                      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                                      minimumSize: Size.zero,
                                      tapTargetSize: MaterialTapTargetSize.shrinkWrap,
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: const Text('Thêm quy tắc', style: TextStyle(fontWeight: FontWeight.w700)),
      ),
    );
  }
}
...
class AddRecurringRuleSheet extends StatefulWidget {
  ...
  const AddRecurringRuleSheet({super.key, this.editRule, required this.onSaved});
    ...
    return Container(
      ...
      child: SafeArea(
        child: SingleChildScrollView(
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: TextStyle(
                          fontWeight: FontWeight.w700,
                          fontSize: 13,
                          color: _selectedType == 'expense' ? AppColors.danger : context.palette.textSecondary,
                        ),
                      ),
                    ),
                  ),
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: TextStyle(
                          fontWeight: FontWeight.w700,
                          fontSize: 13,
                          color: _selectedType == 'income' ? AppColors.success : context.palette.textSecondary,
                        ),
                      ),
                    ),
                  ),
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: TextStyle(
                          fontWeight: FontWeight.w700,
                          fontSize: 12,
                          color: isSelected ? AppColors.teal : context.palette.textSecondary,
                        ),
                      ),
                    ),
                  ),
          ...
          ListTile(
            contentPadding: EdgeInsets.zero,
            leading: const Icon(Icons.access_time_rounded, color: AppColors.teal),
            title: const Text('Giờ chạy tự động', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 13)),
            subtitle: Text(
          ...
          SizedBox(
            ...
            child: FilledButton(
              ...
              child: _saving
                  ...
                  : Text(
                      widget.editRule != null ? 'Lưu thay đổi' : 'Tạo quy tắc định kỳ',
