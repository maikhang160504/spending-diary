...
class _HomeCalendarScreenState extends State<HomeCalendarScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      if (walletsState.status == QueryStatus.error && walletsState.data == null) {
  ...
  Future<void> _loadWalletData() async {
    try {
      ...
      final txF = AppQueries.transactions(_selectedWalletId, pageSize: 100).result;
                          ...
                          children: [
                            ...
                            GridView.builder(
                              ...
                              itemBuilder: (ctx, i) {
                                ...
                                final isToday = _focus.month == DateTime.now().month &&
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              Text('Chào ${_userName.isNotEmpty ? _userName : 'bạn'}!',
                  style: Theme.of(context)
                      .textTheme
                      .titleMedium
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  color: Colors.white.withValues(alpha: 0.2), borderRadius: BorderRadius.circular(AppRadii.md)),
              child: Row(children: [
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            _loading
                ...
                : Text(formatVnd(_balance),
                    style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w700, fontSize: 26)),
            const SizedBox(height: 12),
            Row(children: [
              Expanded(
                  child: _BalanceStat(
                      label: 'Thu nhập', value: _loading ? '...' : formatVnd(_totalIncome), color: AppColors.teal)),
              Container(width: 1, height: 28, color: AppColors.border),
              Expanded(
                  child: _BalanceStat(
                      label: 'Chi tiêu', value: _loading ? '...' : formatVnd(_totalExpense), color: AppColors.danger)),
            ]),
          ]),
        ),
      ]),
  ...
  Widget _buildDayCell(int day, List<dynamic> dayTxList, bool isSelected, bool isToday) {
    ...
    Widget buildCardContent(dynamic tx) {
      ...
      if (imgUrl.isNotEmpty) {
        ...
        final category =
            tx['category_name'] as String? ?? tx['categoryCode'] as String? ?? tx['category_code'] as String? ?? 'Other';
        return Container(
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: isExpense ? AppColors.danger.withValues(alpha: 0.1) : AppColors.teal.withValues(alpha: 0.1),
                      borderRadius: BorderRadius.circular(999),
                    ),
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
        ...
        child: Row(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text(label,
              style: Theme.of(context)
                  .textTheme
                  .bodySmall
                  ?.copyWith(color: isSelected ? AppColors.teal : Colors.white, fontWeight: FontWeight.w600)),
        ]),
      ),
    );
  }
