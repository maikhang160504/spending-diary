            ...
            if (isLandscapeOrWide) {
              return Row(
                ...
                children: [
                  Expanded(
                    flex: 7,
                    child: Column(children: [topBar, cameraPreview]),
                  ),
                  SizedBox(width: 140, child: bottomControls),
                ],
              );
            }

            return Column(children: [topBar, cameraPreview, bottomControls]);
          },
        ),
      ),
    );
...
class _BillScanFrameOverlayState extends State<_BillScanFrameOverlay>
